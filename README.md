...
Project Banner SQL Power BI Domain
...
SQL Pipeline — Run Sydney_House_SQL_Query.sql against a MySQL 8.0+ instance containing the domain_properties source table. Tables will build in order.
Power BI Dashboard — Open Sydney_House_Visualization.pbix in Power BI Desktop. Refresh data source connection to your MySQL instance if needed.
🚀 Future Enhancements
